...
echo_and_run cd "/home/rover/catkin_ws_backup/src/ds4_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rover/catkin_ws_backup/src/ds4_driver/setup.py" \
     \
    build --build-base "/home/rover/catkin_ws_backup/build/ds4_driver" \
    install \
    --root="${DESTDIR-/}" \
