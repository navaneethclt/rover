...
echo_and_run cd "/home/rover/catkin_ws_backup/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rover/catkin_ws_backup/src/vision_opencv/cv_bridge/setup.py" \
    egg_info --egg-base /home/rover/catkin_ws_backup/build/vision_opencv/cv_bridge \
    build --build-base "/home/rover/catkin_ws_backup/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
